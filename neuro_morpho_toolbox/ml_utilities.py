...
def pickCLUSTERpara(method,selected_list):
    ...
    :return: a DataFrame with columns ['ARI', 'NumCluster', 'parameter']
        * For Hierarchy, will be 44986 parameters
        * For Kmeans, will be 60480 parameters
        * For DBSCAN, will be 21200 parameters
        * For HDBSCAN, will be 9198 parameters
        * For SNN_Community, will be 270 parameters
    ''' 
...
def disCal(SOMA_raw,Contour_01,Array_ID, near_n, flipF = True):
    '''
    :param SOMA_raw: a dataframe of soma feature: ns.features['soma_features'].raw_data
...
def findBESTpara(inputDF,clusterRange,num_return):
    '''
    :param inputDF: a dataframe generated by function pickCLUSTERpara, with col ['ARI', 'NumCluster', 'parameter']
...
def fre_Matrix(fre_M, cluster_method,para_DF):
    '''
    :param fre_M: a square DataFrame with same row and col name. Here index is all the neurons
    :param cluster_method: a str indicating the cluster method
    :param para_DF: a dataframe generated by function findBESTpara, with col ['ARI', 'NumCluster', 'parameter']
    :return: a square array with each element being 0 or 1
    ''' 
